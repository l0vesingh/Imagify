  ...
  return (
    ...
    >
        ...
        bg-white px-6 py-1 rounded-full border border-neutral-500'>
               <p>
                Premium and reliable text to image generator
            </p>
            <img src={assets.star_icon} alt="" />
        </motion.div>
        <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px]
        mx-auto mt-10 text-center'>Turn words to <span
        ...
        >
            Got an idea? Watch it come alive as art. 
            Type it, style it, and boom - AI turns your words into visuals instantly.
        </motion.p>
        ...
        initial={{opacity:0}}
        animate={{opacity:1}}
        transition={{default: {duration: 0.5}, opacity:{delay:0.8}, delay:1}}
